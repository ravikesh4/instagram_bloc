...
import 'package:instagram_bloc/repositories/auth/base_auth_repository.dart';
...
class AuthRepository extends BaseAuthRepository {
  ...
  @override
  Future<User> signUpWithEmailAndPassword({@required String username, @required String email, @required String password}) async {
    try {
